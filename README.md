...
This project focuses on analyzing food delivery data inspired by real-world platforms. It involves designing relational tables, performing data analysis, and extracting meaningful business insights using SQL.

The project demonstrates strong SQL skills including joins, aggregations, CTEs, and window functions to analyze customer behavior, restaurant performance, delivery efficiency, and revenue trends.

---

##  Objectives

1. **Set up the Zomato Database**: Create and populate tables for customers, orders, restaurants, deliveries, and riders.
2. **Exploratory Data Analysis (EDA)**: Understand data distribution and structure.
3. **Data Cleaning**: Handle missing/null values.
4. **Advanced SQL Queries**: Generate business insights using joins, CTEs, and window functions.
5. **Business Analysis**: Analyze customer trends, restaurant performance, and delivery metrics.
...
- **Database Schema**: Structured tables representing customers, orders, restaurants, deliveries, and riders along with their relationships.
- **Data Analysis**: Insights into customer ordering behavior, restaurant performance, delivery efficiency, and revenue trends.
- **Summary Reports**: Aggregated data on top-performing restaurants, high-value customers, peak order times, and rider performance.

---

## Conclusion

This project demonstrates the application of SQL in analyzing real-world food delivery data. It covers database design, data cleaning, and advanced querying techniques to extract meaningful business insights.

The analysis helps in understanding customer preferences, optimizing restaurant performance, and improving delivery operations, making it highly relevant for data analyst roles.
